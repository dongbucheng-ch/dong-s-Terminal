...
export function useTilt(
  elementRef,
  options = { max: 3, perspective: 1200, glare: true },
) {
  let cleanup = () => {};
  ...
  onMounted(() => {
    ...
    if (options.glare) {
      ...
      glareEl.style.borderRadius =
        getComputedStyle(el).borderRadius || "inherit";
    ...
    const onMouseMove = (e) => {
      ...
      if (glareEl) {
        ...
        glareEl.style.background = `radial-gradient(circle at ${x}px ${y}px, rgba(255,255,255,0.1) 0%, transparent 25%)`;
      }
    };
